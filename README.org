...
If you export an org document, it also exports the headers. If you only use
headers to outline the document, you want to export the content of each section
without the section title. Package ~ox-extra~ implements the functionality you
to tag such headers using tag ~ignore~:
